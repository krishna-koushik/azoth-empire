...
const { state, onChange } = createStore({
    ...
    isLeader:
        (authService.getRoles() || []).includes('Leaders') || (authService.getRoles() || []).includes('AE Leaders') || (authService.getRoles() || []).includes('AE Bot Admin'),
...
onChange('currentRoles', value => {
    state.isLeader = value.includes('Leaders') || value.includes('AE Leaders') || value.includes('AE Bot Admin');
